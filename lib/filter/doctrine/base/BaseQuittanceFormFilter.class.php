...
/**
 * Quittance filter form base class.
 *
 * @package    Annuaire
 * @subpackage filter
 * @author     Michael Muré
 ...
 */
abstract class BaseQuittanceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('quittance_filters[%s]');
