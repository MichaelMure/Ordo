...
abstract class BaseProjetForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'delai_realisation' => new sfWidgetFormInputText(),
      'respo_id'          => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Membre'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'delai_realisation' => new sfValidatorInteger(array('required' => false)),
      'respo_id'          => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Membre'))),
