...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class='<?php echo $membre->getCurrentQuittance() ? 'vert' : 'rouge' ?>'><?php echo $membre->getCurrentQuittance() ? 'oui' : 'non' ?></td>
      <td class='<?php echo $membre->getCurrentCotisation() ? 'vert' : 'rouge' ?>'><?php echo $membre->getCurrentCotisation() ? 'oui' : 'non' ?></td>
